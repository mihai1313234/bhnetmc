...
const config = {
  ...
  */
  ...
  atGroupsDefaultColors: {
    ...
    MODERATORS: "rgba(230, 83, 0, 0.5)",
    Parteners: "rgba(11, 175, 255, 0.5)",
    Youtube: "rgba(247, 2, 176, 0.5)",
  },
  adminTeamPage: {
    leaders: [
      {
        inGameName: "Mihai14launcher",
        rank: "Owner",
        skinUrlOrPathToFile: "https://lh6.googleusercontent.com/EKqtvbgD2QyVqSnBGDDootzMeTyYeDzvczWFMOFRclzZz_2lE4_A5fvPqkyAofyP_gI8rGgnW0zm4Em7G149KTg=w1280",
        rankColor: "rgba(255, 3, 3, 1)"
      },
      {
        inGameName: "OGM_MAHAI",
        rank: "Owner",
        skinUrlOrPathToFile: "",
        rankColor: "rgba(255, 3, 3, 1)"
      },
    ...
    MODERATORS: [
      {
        inGameName: "rad_777",
        rank: "Staff",
        skinUrlOrPathToFile: "https://lh6.googleusercontent.com/hfMT-qX_zUKaGY8U2Xjb49R-J-RX67ukTWi1cLsJFhmTKKpBnWj-0d3PSIfbikUlXpHzHV0dK5cox8oFRZGXSUaDusgR3vu4QjTz5DZzSrRDSt7DfbeWH5x9TClPZiywmg=w1280",
        rankColor: ""
      },
      {
        inGameName: "dodu.darius",
        rank: "STAFF",
        skinUrlOrPathToFile: "",
        rankColor: ""
      },
    ...
    Parteners: [
      ...
      {
        inGameName: "micutzuglx6886",
        rank: "Parteners",
        skinUrlOrPathToFile: "",
        rankColor: ""
      },
      {
        inGameName: "tony777.6",
        rank: "Parteners",
        skinUrlOrPathToFile: "",
        rankColor: ""
      },
...
const getDiscordOnlineUsers = async () => {
  try {
    ...
    const apiWidgetUrl = `https://discord.com/api/guilds/1135606664612040864/widget.json`;
